...
export default function Experience(props) {
  ...
  const courses = props.coursework.map(function(course) {
    ...
    return (
      ...
      >
        ...
        {course.certificate && <span> | <a className="d-inline text-decoration-none" href={course.certificate} target="_blank" rel="noopener noreferrer">Certificate</a></span>}
    ...
    <section id="resume">
      <div className="col-md-12 mx-auto">
        <div className="col-md-12">
          <h1 className="section-title text-center">Coursework</h1>
        </div>
      </div>
